with
    sales_order_header as (
        select
            ...
            , cast(subtotal as numeric(18,2)) as sales_order_value
            , cast(taxamt as numeric(18,2)) as sales_order_taxes_value
            , cast(freight as numeric(18,2)) as sales_order_freight_value
            , cast(totaldue as numeric(18,2)) as sales_order_total_value
